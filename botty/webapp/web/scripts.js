...
function drawLineGraph(graph, points, container, id) {
    ...
    var graph = Snap(graph);
    $('#chart-1-name').val(chart_1_name);
    $('#chart-2-name').val(chart_2_name);
...
$(window).on('load',function(){
    ...
    function update(){
        $.ajax({
            method: 'GET',
            url: 'http://localhost:8081/webapp_war_exploded/data',
            ...
            success: function (data){
                ...
                if (data.error == 0){
                    ...
                    var chart1 = charts[0];
                    var chart2 = charts[1];
                    chart_1_y = chart1.chart;
                    chart_2_y = chart2.chart;
                    chart_1_name = chart1.name;
                    chart_2_name = chart2.name;
                }
            },
            error: function (xhr) {
